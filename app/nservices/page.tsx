...
const services = [
  {
    ...
    highlights: [
      ...
      "Lower Logistics and Shipping Fees",
...
export default function ServicesPage() {
  return (
    <main className="bg-white min-h-screen">
      ...
      {/* What We Offer Section - Component Categories */}
      <div className="max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            { name: "Passive Components", image: "resistors" },
            { name: "Semiconductors (Active Components)", image: "chip" },
            { name: "Interconnects & Electromechanical", image: "connectors" },
            { name: "Circuit Protection", image: "protection" },
            { name: "Mechanical Components", image: "mechanical" },
            { name: "Board Material", image: "pcb" },
          ].map((item, index) => (
            <motion.div
              key={index}
            ...
            >
              <div className="h-56 bg-gradient-to-br from-slate-100 to-blue-50 flex items-center justify-center relative overflow-hidden">
                {/* You can replace with actual images later */}
                <div className="text-7xl opacity-10 group-hover:scale-110 transition-transform duration-700">
                  ⚡
                </div>
              </div>
              <div className="p-8">
            ...
            {services.map((service, index) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Footer CTA */}
                  <div className="px-9 py-7 border-t border-gray-100 bg-gradient-to-r from-blue-50 to-white mt-auto">
                    <a
                      href="/inquiry-form"
                      className="inline-flex items-center gap-3 text-blue-700 hover:text-blue-800 font-medium group-hover:gap-4 transition-all"
                    >
                      Learn More
